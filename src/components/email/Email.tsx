...
export default class Email extends React.Component<
    ...
    componentDidMount() {
      ...
      if ("browse" in queryParams) {
        ...
        const pathWithoutQuery =
          `${this.props.location.origin}${this.props.location.pathname}`;
    ...
    openEmail() {
      const subject =
        encodeURIComponent(this.siteConfig.defaultSubjectLine.trim());
      const body =
          ...
          <article className="emailContentSection">
            <div className="container">
              <div className="emailContent">
                ...
                <div>
                  <b>Message:</b>&nbsp;
                  <i>(Don't forget to replace the
                    [x]'s with your information!)</i>
                  <span className="copyToClipboard"
                    onClick={() =>
                      this.handleClipboardCopy(
                          { bodyCopied: true },
